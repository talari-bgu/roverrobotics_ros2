...
from launch.actions import DeclareLaunchArgument, GroupAction, IncludeLaunchDescription, SetEnvironmentVariable, LogInfo
...
def generate_launch_description():
    ...
    # Log the values of the launch arguments
    log_namespace = LogInfo(msg=["namespace: ", LaunchConfiguration('namespace')])
    log_use_namespace = LogInfo(msg=["use_namespace: ", LaunchConfiguration('use_namespace')])
    log_map_file = LogInfo(msg=["map file: ", map_file])
    log_use_sim_time = LogInfo(msg=["use_sim_time: ", LaunchConfiguration('use_sim_time')])
    ...
    # Add log actions to print argument values
    ld.add_action(log_namespace)
    ld.add_action(log_use_namespace)
    ld.add_action(log_map_file)
    ld.add_action(log_use_sim_time)
